<?php
	...
	$servico_lista = $o_monta_produto->monta_lista_correspondentes();
	...
	if($_SESSION["acesso"] == "sim")
	{
		switch($_REQUEST['acao'])
		{
			case 'formulario':
				...
				$fancy = "$(document).ready(function (){fancy_function('".$url_virtual."componentes/popup_outros.php?email=".$o_configuracao->email_correspondentes()."&msg=Correspondentes&id_produto_tipo=4',700,575,'iframe')});";
	...
	$template = $o_ajudante->template("".$url_fisico."templates/correspondentes.html");
