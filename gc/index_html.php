...
<body> 
	<div id="topo" class="topo"><img src="../imagens/gc/topo_logo.png" width="50" height="50" alt="" />
		<div id="esquerda">Bem vindo ao Gestor de Conte&uacute;do, <?=$_SESSION["usuario_usuario"]?> (<?=$_SESSION["usuario_adm_tipo"]?> - <?=$_SESSION["usuario_numero"]?>) - &Uacute;ltimo acesso: <?=$_SESSION["usuario_data_hora"]?> 		</div>
