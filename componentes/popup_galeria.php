	...
	switch($_REQUEST['acao'])
	{
		case 'gravar':
			...
			if($o_produto->inserir())
			{
				...
				$mensagem = "Novo cadastro na &aacute;rea de Galeria:\n<br /><br />
				<b>T&iacute;tulo do Projeto:</b>: ".$_REQUEST["titulo"]."\n<br />
				<b>Descri&ccedil;&atilde;o do Projeto:</b>: ".$_REQUEST["descricao"]."\n\n";
				
				if($o_ajudante->email_html($o_configuracao->site_nome()." - Nova solicitação de cadastro",$mensagem,$o_configuracao->email_galeria(),$o_configuracao->email_galeria(),"../templates/template_mailing.htm"))
				{
			...
			$msg_sucesso = "<br> Galeria enviada com sucesso!";
