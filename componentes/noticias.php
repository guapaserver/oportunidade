	...
	if($_SESSION["acesso"] == "sim")
	{
		switch($_REQUEST['acao'])
		{
			case 'formulario':
				...
				$fancy = "$(document).ready(function (){fancy_function('".$url_virtual."componentes/popup_outros.php?email=".$o_configuracao->email_noticias()."&msg=Notícias&id_produto_tipo=1',700,575,'iframe')});";
